...
Complex::Complex(Complex& obj)   // c-tor copy 
{
	this->SetX(obj.GetX());
	this->SetY(obj.GetY());
}

Complex::Complex(Complex&& obj)   // c-tor copy with move
{
	*this = move(obj);
}
...
Complex& Complex::operator=(const Complex& obj)   //оператор = 
{
	if (this == &obj)
	{
		return *this;
...
Complex& Complex::operator=(Complex&& obj)  //оператор = з move
{
	this->x = obj.x;
	this->y = obj.y;
	return *this;
